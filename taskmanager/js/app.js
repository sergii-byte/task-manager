// Sprint 0.2: extracted into separate modules.
//   - dlDate()  → js/dates.js  (Dates.parseLocal, alias kept for back-compat)
//   - Icons     → js/icons.js
//   - Dom.esc / safeColor → js/dom.js  (App.esc/safeColor delegate)
//   - FocusTrap → js/focus-trap.js     (openModalA11y/closeModalA11y delegate)
...
const App = {
    ...
    // ===== Focus trap (delegates to FocusTrap module) =====
    openModalA11y(overlayId)  { FocusTrap.open(overlayId); },
    closeModalA11y(overlayId) { FocusTrap.close(overlayId); },
    ...
    // Sprint 0.2: delegate to Dom module — single source of truth for
    // escaping. Wrappers preserve the dozens of `this.esc(x)` call sites.
    esc(str)        { return Dom.escape(str); },
    safeColor(c)    { return Dom.safeColor(c); },
